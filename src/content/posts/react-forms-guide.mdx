...
The `components.js` and `styles.css` files won't change throughout this guide. They're hidden in later examples so you can focus on the form logic.
...
- Errors persist while typing and only update on resubmit (we will fix this in the next section)
